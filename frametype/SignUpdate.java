...
import javax.swing.*;
public class SignUpdate extends JFrame implements ActionListener
{
	Container c;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==b1)
		{
			...
			try
			{
				...
				PreparedStatement ps=con.prepareStatement("update recptionist set qualification = ? where rid = ? ");
				ps.setString(1,t2.getText().trim());
				ps.setString(2,((String)cb.getSelectedItem()).trim());
