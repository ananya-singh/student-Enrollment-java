...
import javax.swing.*;
public class SignDelete extends JFrame implements ActionListener
{
	Container c;
	JLabel l1,l2;
	JTextField t1;
	...
	public SignDelete()
	{
		...
		l2 = new JLabel("Enter Receptionist Id:");
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==b1)
		{
			try
			{
				Class.forName("oracle.jdbc.driver.OracleDriver");"system","ananya");
				PreparedStatement ps=con.prepareStatement("delete from recptionist where rid =?");
