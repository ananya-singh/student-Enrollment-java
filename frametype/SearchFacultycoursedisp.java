...
class SearchFacultycoursedisp extends JFrame
{
	...
	public 	SearchFacultycoursedisp(String id1)
	{
		...
		try
		{
			...
			PreparedStatement ps=con.prepareStatement("select facname from schdule where course = ? ");
			ps.setString(1,id1);
		...
		c.add(new JLabel("Name of Faculties"),BorderLayout.NORTH);
	...
	{
		//SearchFacultycoursedisp gfg=new SearchFacultycoursedisp("C++");
	}
