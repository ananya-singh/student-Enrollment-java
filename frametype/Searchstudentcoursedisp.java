...
class Searchstudentcoursedisp extends JFrame
{
	...
	Searchstudentcoursedisp(String id1)
	{
		...
		String heading[]={"Name"};
		int sn = 1;
		String data[][]=new String[43][1];
		int r=0;
		try
		{
			Class.forName("oracle.jdbc.driver.OracleDriver");
			Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","ananya");
			PreparedStatement ps=con.prepareStatement("select name from student where courses =?");
			ps.setString(1,id1);
	...
	{
		//Searchstudentcoursedisp njkn = new Searchstudentcoursedisp("Java");
	}
